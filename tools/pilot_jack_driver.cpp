...
int main(int argc,char**argv){ Driver d; d.mode=argc>1?argv[1]:"rec120"; d.wav_path=argc>2?argv[2]:"output.wav"; const bool seq66_mode=d.mode=="seq66"; if(d.mode=="elastic60")d.play_off=436096; else if(d.mode=="elastic240")d.play_off=244096; else if(d.mode=="dynamic"){d.play_off=484096;d.dynamic_a=d.play_on+24000;d.dynamic_b=d.play_on+80000;}
